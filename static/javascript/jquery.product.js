jQuery.fn.product = function(options) {
	...
	return this.each(function(){
		...
		var name = jQuery(this).attr('id') ? jQuery(this).attr('id') : 'product';
		...
		jQuery(this).html(
			...
			'<input class="long-item" type="text" name="'+name+'" value="'+value+'" placeholder="Введите название продукта" />'
		);
		...
		objName.autocomplete({
			source: '/main/dialogs/product/search_product_alone.php',
            minLength: 2,
